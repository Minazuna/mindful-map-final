...
import { Phone, Mail, MapPin, Clock, Globe, AlertCircle, Heart, PhoneCall } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {resource.categories.map((category, idx) => (
                          <span key={idx} className="bg-[#6fba94]/10 text-[#6fba94] text-sm px-3 py-1.5 rounded-full font-medium border border-[#6fba94]/20">
                            {category}
                          </span>
                        ))}
                      </div>
            ...
            {[
              {
                ...
                desc: 'Take a few minutes daily to breathe deeply and be present in the moment.'
              },
              {
                emoji: '🚶',
                title: 'Move Your Body',
                desc: 'Regular exercise and physical activity can significantly boost your mental health.'
              },
              {
                emoji: '💬',
                title: 'Connect with Others',
                desc: 'Share your feelings with trusted friends, family, or mental health professionals.'
              }
            ].map((tip, idx) => (
              <div key={idx} className="bg-gradient-to-br from-[#F1F8E8] to-[#E8F5E8] p-6 rounded-xl text-center border border-[#6fba94]/20 hover:shadow-lg transition">
        ...
        <div className="bg-gradient-to-r from-[#6fba94]/10 to-[#5aa88f]/10 rounded-xl p-6 text-center border border-[#6fba94]/20">
          <p className="text-gray-700 text-lg font-medium">
            <span className="text-[#6fba94] font-bold">Remember:</span> Seeking help is a sign of strength. 
