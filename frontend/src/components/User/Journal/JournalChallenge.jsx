        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {CHALLENGES.map((challenge, idx) => (
            <motion.div
              ...
              whileHover={{
                scale: 1.045,
                boxShadow: "0 12px 32px 0 rgba(67,97,238,0.10)",
              }}
              className={`relative rounded-3xl overflow-hidden border-2 ${challenge.border} bg-white shadow-md transition-all cursor-pointer group`}
              role="button"
              tabIndex={0}
