...
const tukeyHSDSchema = new mongoose.Schema({
  ...
  p_adj: { type: Number, default: null }, // renamed from "p-adj"
...
const anovaResultSchema = new mongoose.Schema({
  ...
  anova: {
    ...
    includedGroups: { type: [String], default: [] },   // added
    ignoredGroups: { type: [String], default: [] },    // added
    tukeyInfo: { type: mongoose.Schema.Types.Mixed }   // added (stores ran/skippedReason/error/variances)
  },
...
// Prevent duplicates per user/category/date
